...
//        out.println(responseHtml);
        ...
        String sId = request.getParameter("studentForSavingCourseArrange");
        ...
        if (sId != null && checkboxCoursescId != null && selectTeacherstId != null && coursesScore != null) {
            try {
                new ServeService().deleteServe(Integer.parseInt(sId));

            } catch (NumberFormatException e) {
                System.out.println("删除学生原来课程计划失败！");
